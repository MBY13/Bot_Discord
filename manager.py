...
class Manager(commands.Cog):
    ...
    # aqui podemos abrir um arquivo json com varios tipos de palavão para que assim tenha uma maneira de impedir palavras
    ...
    @commands.Cog.listener()#Quando retorna um erro entra aqui
